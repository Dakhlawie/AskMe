...
function Contact() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post('http://localhost:8000/api/contacts', contactData)
      .then((response) => {
        console.log('Contact created successfully', response.data);
       
        // Perform actions after contact creation
      })
      .catch((error) => {
    ...
    <div class="container">
      ...
      <section className="contact-area pt-80px pb-80px">
        <div className="container">
          <form
            action="http://techydevs.com/demos/themes/html/disilab-demo/disilab/php/contact.php"
            ...
            <div className="card-body row">
              <div className="col-lg-7">
                ...
                <div className="form-group">
                  <label htmlFor="username" className="fs-14 text-black fw-medium lh-20">
                    Username
                  </label>
                  <input
                    type="text"
                ...
                <div className="form-group">
                  <label htmlFor="email" className="fs-14 text-black fw-medium lh-20">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div className="form-group">
                  <label htmlFor="message" className="fs-14 text-black.
                  fw-medium lh-20"
                  >
                    Message
                  </label>
                ...
                <div className="form-group">
                  <button
                    type="submit"
                    className="btn btn-primary fs-14 fw-medium lh-20"
                  >
                    Submit
                  </button>
